...
export default function GasCylinderShow() {
    const { gasCylinder: { data: detail } = { data: undefined } } = usePage<{ gasCylinder?: { data: GasCylinderProps } }>().props;
        ...
        <>
            ...
            <div className="w-full space-y-6 p-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <StockCard label="Isi" stock={1000} desc="Tabung berisi gas." variant={'fill'} />
